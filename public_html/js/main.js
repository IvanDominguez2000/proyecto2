...
function iniciarPartida() {
    ...
    var Tauler = {
        ...
        inicialitzador: function () {
            ...
            /* incialització de la variable per saber els clicks */
            comptador = 0;
            ...
            if (valor >= 5 && valor <= 20) {
                ...
                for (var numfc = 5; numfc <= 20; numfc++) {
                    if (localStorage.getItem("puntuacio" + numfc) == null) {//si no hi ha res la iniciem amb 0
                ...
                descoberts.innerHTML = "Zombis: " + zombisd + "<br> Estrelles: " + estrellesd + "<br> Doble puntuació: " +
                doblarpuntuacionsd + "<br> Meitat zombis: " + meitatzombisd + "<br> Vides extres: " + videsextresd;
                ...
                totals.innerHTML = "Zombis: " + zombis + "<br> Estrelles: " + estrelles + "<br> Doble puntuació: " + 
                doblarpuntuacions + "<br> Meitat zombis: " + meitatzombis + "<br> Vides extres: " + videsextres
        ...
        mostrarContingut: function () {
            ...
            for (var files = 0; files <= valor - 1; files++) {
                for (var columnes = 0; columnes <= valor - 1; columnes++) {
                    ...
                    casellesTauler.innerHTML += "<button id='" + files + "-" + columnes + "' class='btcaselles'><img src='" + 
                    imatge + "' width='" + width + "' height='" + height + "'></button>";
                }
        ...
        mostrarSolucio: function () {
            ...
            for (var files = 0; files <= valor - 1; files++) {
                for (var columnes = 0; columnes <= valor - 1; columnes++) {
                    ...
                    taulerSolucionat.innerHTML += "<button id='" + files + "-" + columnes + "' class='btcaselles'><img src='" + 
                    imatge + "' width='" + width + "' height='" + height + "'></button>";
                }
        ...
        rutaImatgeSolucio: function (fila, columna) { //segons contingut de l'element retorna una ruta d'imatge
            ...
            switch (Tauler.casellesresposta[fila][columna].contingut) {
                case 'g':
                    imatge = "imagenes/gespa.jpeg";
                    break;
                case 'z':
                    imatge = "imagenes/zombi.jpeg";
                    break;
                case 'e':
                    imatge = "imagenes/estrella.jpeg";
                    break;
                case 'd':
                    imatge = "imagenes/doblepuntuacio.PNG";
                    break;
                case 'm':
                    imatge = "imagenes/meitatzombis.PNG";
                    break;
                case 'v':
                    imatge = "imagenes/vidaextra.jpeg";
                    break;
                default:
                    imatge = "imagenes/estrella.jpeg";
            }
